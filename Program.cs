...
namespace Assi1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            StackingStrategy bottomWeight = fw.GetFlyweight("bottomWeight", new StackingStrategy_BottomWeight());
            StackingStrategy pyramid = fw.GetFlyweight("pyramid", new StackingStrategy_Pyramid());
            StackingStrategy topple = fw.GetFlyweight("topple", new StackingStrategy_Topple());
